...
public class Resistance {
    ...
    public static void addResistanceToPlayer(Player player, int amount) {
        PLAYER_RESISTANCE.put(player, getPlayerResistance(player) + amount);
    }

    public static void removeResistanceFromPlayer(Player player, int amount) {
        PLAYER_RESISTANCE.put(player, getPlayerResistance(player) - amount);
    }
}
