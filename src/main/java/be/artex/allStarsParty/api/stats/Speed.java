...
public class Speed {
    ...
    public static void addSpeedToPlayer(Player player, int amount) {
        setPlayerSpeed(player, getPlayerSpeed(player) + amount);
    }

    public static void removeSpeedFromPlayer(Player player, int amount) {
        setPlayerSpeed(player, getPlayerSpeed(player) - amount);
    }
