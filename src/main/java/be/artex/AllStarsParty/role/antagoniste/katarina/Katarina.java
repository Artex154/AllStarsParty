package be.artex.AllStarsParty.role.antagoniste.katarina;
...
public class Katarina extends Role {
    private final String DESCRIPTION =
            ...
            ChatColor.WHITE + " Vous disposez d'une " + ChatColor.AQUA + "épée en diamant" + ChatColor.WHITE + ", votre" + ChatColor.RED + ChatColor.BOLD + " Dague" + ChatColor.WHITE + ". Elle est enchantée avec" + ChatColor.AQUA + " tranchant 3" + ChatColor.WHITE + ". Lorsque vous tuez un joueur avec, le cooldown de" + ChatColor.GOLD + " Shunpo" + ChatColor.WHITE + " est réinitialisé. \n \n" +
