    ...
    public void whenAssigned(Player player) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                PlayerUtil.sendActionBar(player, ChatColor.GRAY + "» " + ChatColor.BLUE + playersWithAkaza.get(player.getUniqueId()) + " balles " + ChatColor.GRAY + "de " + ChatColor.BLUE + ChatColor.BOLD + "Air Type" + ChatColor.GRAY + " restantes «");
            }
