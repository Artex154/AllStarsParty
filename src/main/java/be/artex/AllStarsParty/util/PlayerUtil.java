...
import be.artex.AllStarsParty.role.protagonistes.mrjack.CostumesHolder;
...
public class PlayerUtil {
    ...
    public static void resetPlayerStates(@NotNull Player player) {
        ...
        Gyomei.playersWithMark.remove(player.getUniqueId());
        Gyomei.playersHitCount.remove(player.getUniqueId());
        Akaza.playersWithAkaza.remove(player.getUniqueId());
    }
